    ...
    def play_isolation(self, time_limit=10000, print_moves=False):
        ...
        while True:
            ...
            try:
                ...
                curr_move_queen1, curr_move_queen2 = self.__active_player__.move(game_copy, legal_player_moves,
...
if __name__ == '__main__':
    ...
    print game_as_text(winner, move_history, termination, board.copy())
